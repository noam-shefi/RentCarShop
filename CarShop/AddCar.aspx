<%@ Page Title="הוספת רכב" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="AddCar.aspx.cs" Inherits="AddCar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="form-container">
        ...
        <br />
        <asp:Button ID="btnAdd" runat="server" Text="הוסף רכב" CssClass="btn" OnClick="btnAdd_Click" />
    </div>
</asp:Content>
